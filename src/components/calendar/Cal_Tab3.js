...
export default function Cal_Tab3() {
return(
<>
...
<div style={{height:'60px', borderRight:'2px solid black', position:'absolute', right:'-11.1%'}} class="vl"></div>
  ...
  <MDBPopover size='sm' id='esv' style={{width:'110px',marginLeft:'40px'}}  placement='right' 
        ...
        <MDBPopover size='sm' id='esv' style={{width:'110px',marginLeft:'149px'}}  placement='right' 
            btnChildren=''>
            <MDBPopoverHeader><b>Податкова декларація за 2022 рік</b></MDBPopoverHeader>
            <MDBPopoverBody>
              <p style={{fontWeight:'600'}}>Здати до 09.02.2023</p>
...
<div style={{height:'60px', borderRight:'2px solid black', position:'absolute', right:'-11.1%'}} class="vl"></div>
  ...
  <MDBPopover size='sm' id='esv2' style={{width:'150px',marginLeft:'40px'}}  placement='right' 
            btnChildren=''>
        ...
        <MDBPopover size='sm' id='esv2' style={{width:'150px',marginLeft:'109px'}}  placement='right' 
            btnChildren=''>
